...
function Heads(props) {
    return (
        <div>
            ...
            <p style={{background: '#ddd3d3', color: '#6b58d6', padding: 10}}>Lorem ipsum dolor sit amet.
                col: {props.col}</p>
        </div>
...
function MessagesHeads(props) {
    return (
        <div>
            <p style={{background: '#ecd840', color: '#0c2c0f', padding: 5}}>Lorem ipsum dolor sit amet.
                Name: {props.basic.name}  </p>
